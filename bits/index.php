		...
		<div id="container">
            ...
            <div id="context">
                <div id="main">
                    ...
                    <p id="bittorrent">and via BitTorrent: <a href="/bits/redeclipse_<?php echo $app['releasever']; ?>_win.torrent">Windows</a> | <a href="/bits/redeclipse_<?php echo $app['releasever']; ?>_nix.torrent">Linux</a> | <a href="/bits/redeclipse_<?php echo $app['releasever']; ?>_combined.torrent">Combined</a></p>
